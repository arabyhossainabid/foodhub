...
export default function ProviderShopPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="container mx-auto px-4 py-12 min-h-screen">
      <Link href="/providers" className="text-orange-500 font-bold flex items-center mb-8 group">
      ...
      <div className="space-y-16">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <span className="bg-orange-500 text-white px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">Premium Kitchen</span>
        ...
        <div className="space-y-12 pb-24">
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-gray-100 pb-8">
            <h2 className="text-5xl font-black text-gray-900 tracking-tight">Our <span className="text-orange-500">Menu</span></h2>
