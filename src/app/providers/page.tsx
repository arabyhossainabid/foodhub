  ...
  return (
    <div className='bg-[#F8F9FB] min-h-screen pt-24 pb-20'>
      ...
      <section className="container mx-auto px-4 mb-20">
         <div className="bg-[#0F1115] rounded-[3.5rem] p-12 md:p-24 text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 max-w-4xl">
               <div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-5 py-2.5 rounded-2xl text-orange-500 text-[10px] font-black uppercase tracking-[0.2em] mb-8">
               ...
               <p className='text-gray-400 text-lg md:text-2xl font-medium leading-relaxed max-w-2xl mb-12'>
