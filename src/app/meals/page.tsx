      ...
      <div className='flex flex-col md:flex-row gap-12'>
        ...
        <aside className='w-full md:w-72 space-y-10 shrink-0'>
              ...
              <div className='flex justify-between items-center'>
                ...
                {selectedCat && (
                  <button
                    ...
                    className='text-xs text-orange-500 font-bold flex items-center'
                  >
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] px-2 py-0.5 rounded-full ${
                        selectedCat === cat.id ? 'bg-white/20' : 'bg-gray-200'
                      }`}
                    >
                      {cat._count?.meals || 0}
                    </span>
          ...
          <div className='bg-[#1C1C1C] rounded-md p-8 text-white space-y-4 relative overflow-hidden'>
            ...
            <h4 className='text-xl font-bold font-extra-bold'>
              Join as a Provider
            </h4>
            <p className='text-sm text-gray-400 leading-relaxed'>
              Grow your business with FoodHub. Start selling today!
            </p>
            <Link href='/register?role=PROVIDER' className='block'>
              <Button
                variant='outline'
                className='w-full border-gray-700 text-orange-500 hover:text-white font-bold hover:bg-orange-500 hover:border-orange-500'
              >
                Apply Now
              </Button>
            </Link>
