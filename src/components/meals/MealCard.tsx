      ...
      <CardContent className='p-6 space-y-4'>
        ...
        <div className='flex items-center text-xs text-gray-400 space-x-3 mb-2'>
          <span className='flex items-center'>
            <Clock size={12} className='mr-1' /> 20-30 min
          </span>
          <span className='flex items-center'>
            <ShieldCheck size={12} className='mr-1' /> Quality
          </span>
        </div>

        <p className='text-gray-500 text-sm line-clamp-2 leading-relaxed h-10'>
          {meal.description ||
            'Fresh and delicious meal prepared with the best ingredients.'}
        </p>
        ...
        <div className='flex items-center justify-between pt-2'>
          <div className='flex flex-col'>
            ...
            <Link href={`/providers/${meal.providerId}`}>
              <span className='text-xs font-bold text-gray-700 hover:text-orange-500 transition-colors'>
